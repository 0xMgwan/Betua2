              ...
              {user && (
                <form onSubmit={handleComment} className="flex gap-2">
                  <MentionInput
                    ...
                    className="w-full px-3 py-2 bg-[var(--background)] border border-[var(--card-border)] rounded-lg text-sm focus:outline-none focus:border-[var(--accent)] transition-colors"
                  />
                  <button
                    type="submit"
